...
function passwd_list($keyword = '')
{
    ...
    $BootstrapEditable             = new Bootstrap5Editable();
    $TadLoginBootstrapEditableCode = $BootstrapEditable->render('.editable', XOOPS_URL . '/modules/tad_login/admin/ajax.php');
    $xoopsTpl->assign('TadLoginBootstrapEditableCode', $TadLoginBootstrapEditableCode);
