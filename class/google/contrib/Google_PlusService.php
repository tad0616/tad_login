...
class Google_ItemScope extends Google_Model
{
    ...
    public function setAbout(self $about)
    {
        $this->about = $about;
    }
    ...
    public function setAddress(self $address)
    {
        $this->address = $address;
    }
    ...
    public function setAudio(self $audio)
    {
        $this->audio = $audio;
    }
    ...
    public function setByArtist(self $byArtist)
    {
    ...
    public function setGeo(self $geo)
    {
        $this->geo = $geo;
    }
    ...
    public function setInAlbum(self $inAlbum)
    {
    ...
    public function setLocation(self $location)
    {
        $this->location = $location;
    }
    ...
    public function setPartOfTVSeries(self $partOfTVSeries)
    {
    ...
    public function setReviewRating(self $reviewRating)
    {
    ...
    public function setThumbnail(self $thumbnail)
    {
