...
define('_MA_TADLOGIN_STEP6_1', "<p>接著請選擇「basic setup」</p>");
define('_MA_TADLOGIN_STEP7', "<h1>【步驟 2】建立新的應用程式</h1><p><ol><li>「Display Name」即「顯示名稱」就填一個您看得懂的中文即可，例如「快速登入」</li><li>「Namespace」或「命名空間」填入一個英文代號（僅能小寫英文字母和底線或-符號，數字或中文不行），例如：xxx_login，至少七個字以上。</li><li>「類別」就隨便選一個吧！</li></ol></p>");
define('_MA_TADLOGIN_STEP8', "<h1>【步驟 3】驗證</h1><p>請努力通過煩人的驗證碼。</p>");
define('_MA_TADLOGIN_STEP9', "<h1>【步驟 4】最重要的資訊</h1><p>上面的「App ID」或「應用程式 ID」和「App Secret」或「應用程式密鑰」 就是等一下要填到XOOPS快速登入偏好設定的兩個值。</p>");
...
define('_MA_TADLOGIN_STEP14', "<h1>【步驟 9】確定有開放功能</h1><p>請點選「App Review」將開關切換成「是」即可。</p>");
