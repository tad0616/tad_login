...
<div class="vtable">
    ...
    <{foreach from=$all_content item=data}>
        <ul>
            ...
            <li class="vm"><a href="javascript:delete_tad_login_config_func(<{$data.config_id}>);" class="btn btn-sm btn-danger"><{$smarty.const._TAD_DEL}></a>
                <a href="<{$action}>?op=tad_login_config_form&config_id=<{$data.config_id}>" class="btn btn-sm btn-warning"><{$smarty.const._TAD_EDIT}></a></li>
        </ul>
    <{/foreach}>
</div>
