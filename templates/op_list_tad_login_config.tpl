...
<div class="vtable">
    ...
    <{foreach from=$all_content item=data}>
        <ul>
            ...
            <li class="vm"><span class="badge badge-info bg-info"><{$data.group_id}></span><{$data.group_name}></li>
...
<div class="text-center" style="margin: 30px;">
    <a href="<{$action|default:''}>?op=tad_login_config_form" class="btn btn-primary"><i class="fa fa-square-plus" aria-hidden="true"></i>  <{$smarty.const._TAD_ADD}></a>
</div>
